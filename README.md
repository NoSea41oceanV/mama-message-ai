...
主デモは、保護者が不在の家庭でベビーシッターと過ごしている子どもが、嬉しかったことや寂しい気持ちを声で伝える場面です。同席するベビーシッターや保護者などの大人が必要に応じて操作を助け、子どもに寄り添います。「駄々をこねる子を黙らせる」用途ではなく、その場の大人が寄り添う際の気持ちの切り替えを補助します。

MVPの主利用場面は、ベビーシッター同席での家庭内利用です。将来の利用場面として、就寝前、出張・単身赴任、祖父母の預かり、保育園から帰宅後の成功体験、誕生日・発表会、一時的な入院・別居を想定しています。保育園内での自由利用はMVP対象外の将来展開です。危険・深刻な相談では動画を生成せず、その場にいる信頼できる大人への相談を案内します。
