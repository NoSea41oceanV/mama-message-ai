    ...
    try {
      ...
      if (task.status === "ready") {
        if (task.prepared === true && !task.videoUrl) {
          // Reusable photo avatars can continue to depend on their uploaded
          // source asset after HeyGen reports the avatar as ready. Retain it
          // until the avatar/profile is explicitly replaced or deleted.
